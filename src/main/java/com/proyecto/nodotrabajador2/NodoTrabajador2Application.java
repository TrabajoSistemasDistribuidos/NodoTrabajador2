package com.proyecto.nodotrabajador2;
...
public class NodoTrabajador2Application implements CommandLineRunner {

    public static void main(String[] args) {
        SpringApplication.run(NodoTrabajador2Application.class, args);
    }
